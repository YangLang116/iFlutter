...
public class DartRFileGenerator {
    ...
    private String generateFile(@NotNull Project project, @NotNull VirtualFile rDirectory,
        ...
        String content = buildFileContent(project, className, projectName, projectVersion, resPrefix, assetFileNames);
    ...
    private String buildFileContent(@NotNull Project project,
                                    ...
                                    @NotNull String projectName, @NotNull String projectVersion,
                                    @NotNull String resPrefix, @NotNull List<String> assetFileNames) {
        StringBuilder template = new StringBuilder();
        template.append("/// Generated file. Do not edit.\n")
        ...
        //private constructor
        template.append(String.format("  %s._();\n\n", className));
        //create name and version
        template.append("  static const String PLUGIN_NAME = '").append(projectName).append("';\n");
        template.append("  static const String PLUGIN_VERSION = '").append(projectVersion).append("';\n");
        for (String assetFileName : assetFileNames) {
            ...
            template.append("  static const String ")
