...
public class DartFontFileGenerator {
    ...
    private void generateFile(Project project, VirtualFile rDirectory,
        ...
        String content = buildFileContent(resPrefix, fontAssetList);
        DartUtils.createDartFile(project, rDirectory, FONT_FILE_NAME, content);
    }

    @NotNull
    private static String buildFileContent(@NotNull String resPrefix, @NotNull List<String> fontAssetList) {
