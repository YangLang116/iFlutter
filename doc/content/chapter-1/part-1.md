...
![资源联动动效](https://cdn.jsdelivr.net/gh/YangLang116/iFlutter/doc/configs/dynamic_res.gif)

- 其中 `指定的目录` ，并不是 `iFlutter` 所固定要求的，开发者可自行配置，默认 `images`、 `assets`，具体配置如下：  

![资源联动配置](https://cdn.jsdelivr.net/gh/YangLang116/iFlutter/doc/configs/config_gen_r.png)
...
![资源联动配置](https://cdn.jsdelivr.net/gh/YangLang116/iFlutter/doc/configs/config_ignore_field.png)

- 如果AndroidStudio安装了 `iFlutter` 插件，资源自动注册功能默认打开，如果想禁用此功能，可配置关闭，配置如下:

![资源联动配置](https://cdn.jsdelivr.net/gh/YangLang116/iFlutter/doc/configs/config_enable_psi.png)
...
![资源生成前缀](https://cdn.jsdelivr.net/gh/YangLang116/iFlutter/doc/configs/res_with_package.png)
