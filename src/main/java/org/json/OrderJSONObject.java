...
public class OrderJSONObject {
     ...
     *                       duplicated key.
     */
    public OrderJSONObject(JSONTokener x) throws JSONException {
        this();
        char c;
        String key;
     ...
     *                       duplicated key.
     */
    public OrderJSONObject(String source) throws JSONException {
...
// Shave off trailing zeros and decimal point, if possible.
     ...
     */
    public OrderJSONObject increment(String key) throws JSONException {
     ...
     */
    public OrderJSONObject put(String key, boolean value) throws JSONException {
     ...
     * @throws NullPointerException If the key is <code>null</code>.
     */
    public OrderJSONObject put(String key, Collection<?> value) throws JSONException {
     ...
     * @throws NullPointerException If the key is <code>null</code>.
     */
    public OrderJSONObject put(String key, double value) throws JSONException {
     ...
     * @throws NullPointerException If the key is <code>null</code>.
     */
    public OrderJSONObject put(String key, float value) throws JSONException {
     ...
     * @throws NullPointerException If the key is <code>null</code>.
     */
    public OrderJSONObject put(String key, int value) throws JSONException {
     ...
     * @throws NullPointerException If the key is <code>null</code>.
     */
    public OrderJSONObject put(String key, long value) throws JSONException {
     ...
     * @throws NullPointerException If the key is <code>null</code>.
     */
    public OrderJSONObject put(String key, Map<?, ?> value) throws JSONException {
     ...
     * @throws NullPointerException If the key is <code>null</code>.
     */
    public OrderJSONObject put(String key, Object value) throws JSONException {
        if (key == null) {
     ...
     */
    public OrderJSONObject putOnce(String key, Object value) throws JSONException {
     ...
     */
    public OrderJSONObject putOpt(String key, Object value) throws JSONException {
        if (key != null && value != null) {
            return this.put(key, value);
        }
        return this;
